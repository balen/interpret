class Interpret::MissingTranslationsController < Interpret::BaseController
  ...
  def blank
    ...
    @ref_translations = Interpret::Translation.allowed.locale(I18n.default_locale).where(key: @blank_translations.map(&:key))
  ...
  def unused
    ...
    used_keys = Interpret::Translation.allowed.locale(I18n.default_locale).all.map(&:key)
  ...
  def stale
    ...
    refs = Interpret::Translation.locale(I18n.default_locale).where(key: @stale_translations.map(&:key))
